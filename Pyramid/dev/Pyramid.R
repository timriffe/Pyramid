...
# TODO, Myer and Whipple indicators (to console). 
# Optional Myer blended digit smoothing (when digit preference exceeds a certain threshold).

# W = number of ages ending on a 0 or 5	  /   1/5 * all ages * 100

# Myers: http://data.princeton.edu/eco572/digitpref.html

# saved png from siegel and swanson methods and materials that demonstrates the method.
Pyramid <-
